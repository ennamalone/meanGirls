...
//							if(currPlayer.getPosition() == Board.squares[30])
//							{
//								
//							}
						...
						if(inJail = true)
						{
							...
							{
								ui.displayString("You are still in jail, roll a double or pay £50 to get out of jail.");
								...
								case UI.CMD_ROLL :
									...
									else if(!dice.isDouble())
									{
										...
										ui.displayString("You did not roll a double so you must remain in jail. If you would like to escape"
												+ "by paying a fine of £50, please type 'pay fine'.");
										switch (ui.getCommandId()) 
										{
										case UI.CMD_PAY_RELEASE :
